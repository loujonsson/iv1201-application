...
-- name appservspringrecruitment. Create such a database before running this script, then run
-- the script with the command
-- psql -d appservspringrecruitment -f src/main/scripts/db/create-appservspringrecruitment-postgres.sql
