...
/**
 * "This is an ugly hack that is needed because spring can not inject brans
 * into JPA entities, since those are created by JPA and the spring DI container
 * is unaware of them.
 *
 * Code taken from Leif Lindbäck
 */
@Service
